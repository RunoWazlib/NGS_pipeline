...
def generate_alignment_stats(aligned_bam_path, output_directory):
    ...
    try:
        ...
        print(f"[!] samtools flagstat failed!")
        print(f"{e.stderr}")
    ...
    try:
        ...
        print(f"[!] samtools stat failed!")
        print(f"{e.stderr}")

    stats_file = f"{output_directory}/alignment_stats/full_alignment_stats.txt"
    prefix_mapping = {
    ...
    out_files = {
        prefix: open(f"{output_directory}/alignment_stats/{filename}", "w")
